...
!
    ...
    if ( 3 < prin ) then
      call r8mat_print ( v, n, n, '  The new direction vectors' )
    end if
...
!
    ...
    if ( 3 < prin ) then
      call r8mat_print ( v, n, n, '  The principal axes:' )
    end if
!
...
subroutine r8mat_print ( a, m, n, title )
